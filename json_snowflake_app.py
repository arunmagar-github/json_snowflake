...
def get_running_order_list():
  with my_cnx.cursor() as my_cur:
    my_cur.execute("select order_details:order_id,order_details:user_id,order_details:user_name ,order_details:order_datetime ,order_details:status,order_details:email,order_details:origin_location ,order_details:destination_location from order_db.public.orders where order_details:status !='delivered'")
